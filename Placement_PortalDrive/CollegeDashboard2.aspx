<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollegeDashboard2.aspx.cs" Inherits="Placement_PortalDrive.CollegeDashboad" %>
         ...
         <div class="col-md-12">
           ...
           <div class="card-body">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DriveDate" HeaderText="Drive Date" />
                    <asp:BoundField DataField="Location" HeaderText="Location" />
                    <asp:BoundField DataField="Position" HeaderText="Position" />
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:Button ID="btnApply" runat="server" CommandName="Apply" CommandArgument='<%# Eval("Id") %>' Text="Apply" CssClass="btn btn-primary" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                </asp:GridView>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <asp:GridView ID="GridViewCompanyInfo" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-striped">
                                <Columns>
                                    <asp:BoundField DataField="CompanyName" HeaderText="Company Name" />
