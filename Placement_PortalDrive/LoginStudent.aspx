<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginStudent.aspx.cs" Inherits="Placement_PortalDrive.LoginStudent" %>
...
<body>
    <div class="header">
        <h3>Placement Drive Student Login</h3>
    </div>
    <br />
    <form id="form1" runat="server" class="form-container">
        ...
        <div class="text-center">
            <a href="RegisterStudent.aspx">Don't Have an Account? Register</a>
        </div>
    </form>
    <br />
